...
- [felddy/ansible-homelab](https://github.com/felddy/ansible-homelab) -  (5 days ago)
...
- [cisagov/gh-skeleton](https://github.com/cisagov/gh-skeleton) ([v1.0.1](https://github.com/cisagov/gh-skeleton/releases/tag/v1.0.1), 1 week ago) - This extension for the gh CLI provides the ability to easily start new projects from our existing library of skeleton repositories.
