...
- [cisagov/guacscanner](https://github.com/cisagov/guacscanner) ([v3.0.3](https://github.com/cisagov/guacscanner/releases/tag/v3.0.3), 2 days ago) - Scan for EC2 instances added (removed) from a VPC and create (destroy) the corresponding Guacamole connections.
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v14.365.0](https://github.com/felddy/foundryvtt-docker/releases/tag/v14.365.0), 6 days ago) - An easy-to-deploy containerized Foundry Virtual Tabletop server.
- [markusressel/fan2go](https://github.com/markusressel/fan2go) ([0.15.0](https://github.com/markusressel/fan2go/releases/tag/0.15.0), 4 weeks ago) - A simple daemon providing dynamic fan speed control based on temperature sensors.
