...
- [cisagov/debian-packer](https://github.com/cisagov/debian-packer) ([v0.1.12-rc.3](https://github.com/cisagov/debian-packer/releases/tag/v0.1.12-rc.3), 1 day ago) - Create a Debian AMI
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v11.315.1](https://github.com/felddy/foundryvtt-docker/releases/tag/v11.315.1), 4 days ago) - An easy-to-deploy Dockerized Foundry Virtual Tabletop server.
- [cisagov/pca-gophish-composition](https://github.com/cisagov/pca-gophish-composition) ([v0.4.0](https://github.com/cisagov/pca-gophish-composition/releases/tag/v0.4.0), 6 days ago) - Phishing campaign docker composition for Gophish
