...
- [cisagov/guacamole-packer](https://github.com/cisagov/guacamole-packer) ([v1.3.0-rc.1](https://github.com/cisagov/guacamole-packer/releases/tag/v1.3.0-rc.1), 1 day ago) - Create machine images containing the Guacamole remote desktop gateway
- [cisagov/debian-packer](https://github.com/cisagov/debian-packer) ([v0.2.0-rc.1](https://github.com/cisagov/debian-packer/releases/tag/v0.2.0-rc.1), 1 day ago) - Create a Debian AMI
- [cisagov/skeleton-packer](https://github.com/cisagov/skeleton-packer) ([v1.0.0](https://github.com/cisagov/skeleton-packer/releases/tag/v1.0.0), 5 days ago) - A skeleton project for quickly getting a new cisagov packer project started.
