...
- [cisagov/debian-packer](https://github.com/cisagov/debian-packer) ([v0.1.12-rc.6](https://github.com/cisagov/debian-packer/releases/tag/v0.1.12-rc.6), 1 day ago) - Create a Debian AMI
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v11.315.1](https://github.com/felddy/foundryvtt-docker/releases/tag/v11.315.1), 5 days ago) - An easy-to-deploy Dockerized Foundry Virtual Tabletop server.
