...
- [cisagov/nessus-packer](https://github.com/cisagov/nessus-packer) ([v1.0.0-rc.2](https://github.com/cisagov/nessus-packer/releases/tag/v1.0.0-rc.2), 1 week ago) - Create machine images containing the Nessus vulnerability scanner
...
- [cisagov/terraformer-packer](https://github.com/cisagov/terraformer-packer) ([v1.0.0-rc.2](https://github.com/cisagov/terraformer-packer/releases/tag/v1.0.0-rc.2), 2 weeks ago) - Create an AMI that can be used to deploy AWS resources via Terraform.
