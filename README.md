...
- [felddy/weewx-prometheus-exporter](https://github.com/felddy/weewx-prometheus-exporter) -  (1 month ago)
...
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v11.298.0](https://github.com/felddy/foundryvtt-docker/releases/tag/v11.298.0), 4 days ago) - An easy-to-deploy Dockerized Foundry Virtual Tabletop server.
...
- [felddy/weewx-docker](https://github.com/felddy/weewx-docker) ([v4.10.2](https://github.com/felddy/weewx-docker/releases/tag/v4.10.2), 3 months ago) - Docker container for WeeWx weather station server
- [cisagov/awssh](https://github.com/cisagov/awssh) ([v1.1.0](https://github.com/cisagov/awssh/releases/tag/v1.1.0), 3 months ago) - Tool to simplify secure shell connections over AWS simple systems manager.
- [cisagov/lcgit](https://github.com/cisagov/lcgit) ([v0.2.0](https://github.com/cisagov/lcgit/releases/tag/v0.2.0), 3 months ago) - A pythonic Linear Congruential Generator iterator
