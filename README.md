...
- [felddy/weewx-docker](https://github.com/felddy/weewx-docker) ([v5.4.0](https://github.com/felddy/weewx-docker/releases/tag/v5.4.0), 3 weeks ago) - Docker container for WeeWx weather station server
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v14.364.0](https://github.com/felddy/foundryvtt-docker/releases/tag/v14.364.0), 4 weeks ago) - An easy-to-deploy containerized Foundry Virtual Tabletop server.
