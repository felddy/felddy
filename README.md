...
- [felddy/cyhy-commander](https://github.com/felddy/cyhy-commander) -  (3 weeks ago)
...
- [felddy/weewx-docker](https://github.com/felddy/weewx-docker) ([v5.4.0](https://github.com/felddy/weewx-docker/releases/tag/v5.4.0), 5 days ago) - Docker container for WeeWx weather station server
- [felddy/foundryvtt-docker](https://github.com/felddy/foundryvtt-docker) ([v14.364.0](https://github.com/felddy/foundryvtt-docker/releases/tag/v14.364.0), 1 week ago) - An easy-to-deploy containerized Foundry Virtual Tabletop server.
- [cisagov/guacscanner](https://github.com/cisagov/guacscanner) ([v3.0.2](https://github.com/cisagov/guacscanner/releases/tag/v3.0.2), 4 weeks ago) - Scan for EC2 instances added (removed) from a VPC and create (destroy) the corresponding Guacamole connections.
- [markusressel/fan2go](https://github.com/markusressel/fan2go) ([0.14.0](https://github.com/markusressel/fan2go/releases/tag/0.14.0), 1 month ago) - A simple daemon providing dynamic fan speed control based on temperature sensors.
...
#### ❤️ Latest sponsors
- [Deniz Laun](https://github.com/Hydroxi) (3 days ago)
